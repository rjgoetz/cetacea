...
<nav class="drawer-menu">
  ...
  <ul>
    ...
    <li><a <?php set_subnav_path("/ergonomics"); ?>>Ergonomics<img src="<?php echo $siteroot; ?>/img/chevron-rt-wht.svg" alt="right chevron"></a></li>
    ...
    <li><a <?php set_subnav_path("/system-bundles"); ?>>System Bundles<img src="<?php echo $siteroot; ?>/img/chevron-rt-wht.svg" alt="right chevron"></a></li>
