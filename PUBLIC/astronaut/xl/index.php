...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Astronaut XL | Cetacea Sound</title>
            ...
            <div class="wrap desktop-wrap">
              <div class="row">
                ...
                <div>
                  ...
                  <article>
                    <h2>Powerful, Full-Range Audio</h2>
                    <div class="row">
                      <div>
                  ...
                  <article>
                    ...
                    <p>
                      Choose from 3 Astronaut system packages for different power applications. Prior to installation, identify your room's power resources and source devices to determine any additional required cables or adapters. Information for installing the Astronaut can be found on the <a href="../installation">installation</a> page.
                    </p>
                    <table>
                      <thead>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Astronaut XL Speaker</td>
                          <td>Astronaut XL Speaker</td>
                          <td>Astronaut XL Speaker</td>
                        </tr>
                        <tr>
                          <td>Ceiling Mount Kit</td>
                          <td>Ceiling Mount Kit</td>
                          <td>Ceiling Mount Kit</td>
                        </tr>
                        <tr>
                          <td>Wall Mount Power Supply</td>
                          <td>Desktop Power Supply</td>
                          <td>Wall Mount Power Supply</td>
                        </tr>
                        <tr>
                          <td></td>
                          <td></td>
                          <td>30' DC Power Ext. Cable</td>
                        </tr>
                      </tbody>
                    </table>
                  </article>
