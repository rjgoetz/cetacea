          ...
          <section>
            ...
            <div class="wrap desktop-wrap">
              <div class="row">
                  ...
                  <aside class="left-nav">
                    <nav>
                      <ul>
                        ...
                        <li class="left-nav-active"><a href="index.php">Hookup Diagrams</a></li>
                        <li><a href="../../room-arrangements/">Room Arrangements</a></li>
                ...
                <!-- start column -->
                <div>
                  <h1>Hookup Diagrams</span></h1>

                  <article>
                    <h2>Common Source Connections</h2>
                    <div class="row">
                      <div class="diagram">
                        <p>Media Player / Smart Phone</p>
            ...
            <nav class="drawer-menu">
              ...
              <ul>
                ...
                <li><a class="active" href="index.php">Hookup Diagrams<img src="../../img/chevron-rt-wht.svg" alt=""></a></li>
                <li><a href="../room-arrangements/">Room Arrangements<img src="../../img/chevron-rt-wht.svg" alt=""></a></li>
